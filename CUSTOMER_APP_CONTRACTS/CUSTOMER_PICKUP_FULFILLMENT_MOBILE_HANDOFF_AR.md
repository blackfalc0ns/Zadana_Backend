...
`name` مربوط باسم المتجر حسب لغة التطبيق (`Accept-Language`): عربي → `BusinessNameAr`، إنجليزي → `BusinessNameEn`، مع تمييز الفرع لو في أكثر من فرع (مثال: `بقالة الأمل — 2` / `Amal Grocery — 2`).

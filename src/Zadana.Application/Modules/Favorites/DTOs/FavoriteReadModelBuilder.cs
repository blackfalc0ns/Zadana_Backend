            ...
            .Select(offer =>
            {
                ...
                return new
                {
                    ...
                    Offer = new FavoriteItemSource(
                        offer.MasterProductId,
                        offer.CreatedAtUtc,
                        FavoriteProjectionMapper.NormalizeText(offer.NameAr),
                        FavoriteProjectionMapper.NormalizeText(offer.NameEn),
                        FavoriteProjectionMapper.PickLocalized(offer.NameAr, offer.NameEn),
                        FavoriteProjectionMapper.NormalizeText(offer.StoreAr),
                        FavoriteProjectionMapper.NormalizeText(offer.StoreEn),
                        FavoriteProjectionMapper.PickLocalized(offer.StoreAr, offer.StoreEn),
                        offer.SellingPrice,
                        offer.CompareAtPrice,
                        FavoriteProjectionMapper.NormalizeText(offer.UnitAr),

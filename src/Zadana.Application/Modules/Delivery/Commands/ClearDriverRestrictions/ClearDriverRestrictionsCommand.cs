    ...
    public async Task Handle(ClearDriverRestrictionsCommand request, CancellationToken cancellationToken)
    {
        ...
        await _notificationService.SendToUserAsync(
            ...
            new NotificationDispatchRequest(
                "تم فك حظر الحساب",
                "Driver restrictions cleared",
                "تم فك القيود التشغيلية عن حسابك ويمكنك العودة لاستقبال العروض عند تفعيل التوفر.",
                "Your operational restrictions were cleared. You can receive offers again after going available.",

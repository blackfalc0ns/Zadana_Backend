...
public class RegionDeliveryPricingSettings : BaseEntity
{
    public Guid SaudiRegionId { get; private set; }
    ...
    private RegionDeliveryPricingSettings() { }

    public RegionDeliveryPricingSettings(
        Guid saudiRegionId,

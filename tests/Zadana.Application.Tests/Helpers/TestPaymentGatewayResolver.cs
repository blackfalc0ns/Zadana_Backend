...
/// <summary>
/// Test resolver that exposes a fake <see cref="IPaymentGateway"/> with the
/// configured <see cref="IPaymentGateway.IsEnabled"/> flag. Network methods
/// throw so accidental calls fail loud.
/// </summary>

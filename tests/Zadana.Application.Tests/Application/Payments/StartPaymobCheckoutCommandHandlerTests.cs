...
public class StartPaymobCheckoutCommandHandlerTests
{
    ...
    public async Task Handle_WhenCardCheckoutSucceeds_ShouldCreatePendingPaymentAndReturnIframeUrl()
    {
        ...
        var order = new Order("ORD-TEST-001", user.Id, Guid.NewGuid(), address.Id, PaymentMethodType.Card, 100m, 0m, 10m, 10m, 0m, 0m, null, null, null, 0m, 0m, 0m, 0m, null, null, false, null, null, null, null, 1, false, 5m);

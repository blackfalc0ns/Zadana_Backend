...
public class ConfirmPaymobPaymentCommandHandlerTests
{
    ...
    private static Order CreateOrder(Guid userId) =>
        new("ORD-PAY-001", userId, Guid.NewGuid(), Guid.NewGuid(), PaymentMethodType.Card, 100m, 0m, 10m, 10m, 0m, 0m, null, null, null, 0m, 0m, 0m, 0m, null, null, false, null, null, null, null, 1, false, 5m);

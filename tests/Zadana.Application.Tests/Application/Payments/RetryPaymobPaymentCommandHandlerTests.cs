...
public class RetryPaymobPaymentCommandHandlerTests
{
    ...
    {
        var order = new Order("ORD-RETRY-001", userId, Guid.NewGuid(), addressId, PaymentMethodType.Card, 100m, 0m, 10m, 10m, 0m, 0m, null, null, null, 0m, 0m, 0m, 0m, null, null, false, null, null, null, null, 1, false, 5m);
